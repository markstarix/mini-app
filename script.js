const REF_LINK = "https://1wbsds.life/v3/7001/promo-ipl-india";
...
function showTab(tab) {
  ...
  if (tab === "home") {
    ...
    content.innerHTML = `<div class="card"><h2 style="text-align:center">✈️ Aviator</h2><p style="text-align:center;color:#aaa;margin-top:30px">Live game coming soon</p></div>`;
  }
  else if (tab === "refer") {
    content.innerHTML = `
      <div class="card">
    ...
    content.innerHTML = `<div class="card"><h3>Settings</h3><p>Language and account settings</p></div>`;
  }
}
